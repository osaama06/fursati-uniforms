...
export default async function EditPage() {
  ...
  return (
    <main dir="rtl" style={{ maxWidth: '700px', margin: '40px auto', padding: '0 20px' }}>
      <h1 style={{ fontSize: '1.6rem', marginBottom: '30px' }}>✏️ تعديل البيانات</h1>
      <EditForm customerId={customer.id} firstName={customer.first_name} lastName={customer.last_name} />
    </main>
  );
}